    ...
    <main className="mx-auto max-w-3xl px-6 py-10">
      ...
      <div className="mt-6 space-y-8 text-sm leading-7 text-[var(--text-secondary)]">
        <section>
          ...
          <p>
            Drag cards between columns as work progresses, or use the <strong>+</strong> create menu
            in the toolbar or <strong>+ Add job</strong> on a column.
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>
            ...
            about today&apos;s jobs, draft estimates, or analyze pipeline health. When a job panel
            is open, the dock switches to card context automatically.
          </p>
        </section>
        <section>
          ...
          <p>
            ...
            pipeline: <strong>/</strong> or <strong>⌘K</strong> focuses job search,{' '}
            <strong>N</strong> opens New job, <strong>`</strong> toggles the sidebar, and arrow keys
            jump pipeline groups in full (19-column) mode.
          </p>
        </section>
        <section>
