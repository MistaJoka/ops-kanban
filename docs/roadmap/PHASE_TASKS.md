...
| ID           | Task                                            | Status | Tests                   | Deps |
| ------------ | ----------------------------------------------- | ------ | ----------------------- | ---- |
| TASK-P13-001 | Outbound sync queue + fire-and-forget mutations | done   | UNIT-SYNC-_, E2E-SYNC-_ | P12  |

---

## Phase 14 — AI slop detection system

**Goal:** Prevention gates, automated structural checks, baseline audit, and mega-file remediation.  
**DoD:** `AI_SLOP_DETECTION.md` wired; `check:slop` in CI; P0 files under 600 lines.  
**Depends on:** P13

| ID           | Task                                     | Status | Tests             | Deps    |
| ------------ | ---------------------------------------- | ------ | ----------------- | ------- |
| TASK-P14-001 | Slop docs + protocol + EXP-VIS-01        | done   | manual            | P13     |
| TASK-P14-002 | Prettier + check-slop-health + CI        | done   | check:slop        | P14-001 |
| TASK-P14-003 | Baseline audit + PRB-SLOP + LEARN-016    | done   | —                 | P14-002 |
| TASK-P14-004 | Split KanbanBoard.tsx                    | done   | unit + e2e:smoke  | P14-003 |
| TASK-P14-005 | Split useCardMutations.ts                | done   | unit              | P14-004 |
| TASK-P14-006 | Tighten slop allowlist (500 line target) | done   | check:slop-health | P14-005 |
